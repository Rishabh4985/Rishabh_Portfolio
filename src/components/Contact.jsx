  ...
  const socials = [
    {
      ...
      link: "mailto:rishabhgarg4985@gmail.com",
    ...
    },
    {
      ...
      link: "https://www.linkedin.com/in/rishabhgarg1000/",
  ...
  return (
    ...
    >
      ...
      <div className="max-w-5xl mx-auto">
        <div
          className={`grid md:grid-cols-2 gap-0 rounded-3xl overflow-hidden shadow-2xl border transition-all duration-500 ${
            isDark
        ...
        >
          ...
          <div
            className={`p-12 flex flex-col justify-between transition-all duration-500 ${
              isDark
          ...
          >
            ...
            <div className="text-center">
              <div className="mb-8">
                <img
                  src="https://media.licdn.com/dms/image/v2/D5603AQGD1_LUSQmQ8A/profile-displayphoto-crop_800_800/B56Zf40HasHUAI-/0/1752226102148?e=1767225600&v=beta&t=Tq9Xe5tsiFH0DZOBmqOX2xCLgbBmqgeyk5jQQ_pt_A0"
                  alt="Rishabh Garg"
